...
COMPANY_LIST = [
    ...
    "tiktok", "twitter", "x", "openai", "stripe", "uber", "airbnb", "shopify", "coinbase", "binance", "bytedance"
]
COMMON_JOB_TITLES = ["engineer", "developer", "manager", "architect", "scientist", "analyst", "designer", "intern", "consultant", "officer", "lead"]
COMMON_WORDS = ["position", "opening", "opportunity", "job", "team", "hiring"]
